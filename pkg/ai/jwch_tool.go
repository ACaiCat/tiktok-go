...
func jwchLoginTool() LocalTool[JwchLoginInput, JwchLoginOutput] {
	return LocalTool[JwchLoginInput, JwchLoginOutput]{
		...
		Description: "Logs in to the Jwch system using one of the two user IDs in the current chat only. Use this as the required login tool when cookies or credentials are unavailable in the context.",
