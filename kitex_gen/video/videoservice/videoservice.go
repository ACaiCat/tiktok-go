...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"VisitVideo": kitex.NewMethodInfo(
		visitVideoHandler,
		newVideoServiceVisitVideoArgs,
		newVideoServiceVisitVideoResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func visitVideoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*video.VideoServiceVisitVideoArgs)
	realResult := result.(*video.VideoServiceVisitVideoResult)
	success, err := handler.(video.VideoService).VisitVideo(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newVideoServiceVisitVideoArgs() interface{} {
	return video.NewVideoServiceVisitVideoArgs()
}

func newVideoServiceVisitVideoResult() interface{} {
	return video.NewVideoServiceVisitVideoResult()
}
...
func (p *kClient) VisitVideo(ctx context.Context, req *video.VisitVideoReq) (r *video.VisitVideoResp, err error) {
	var _args video.VideoServiceVisitVideoArgs
	_args.Req = req
	var _result video.VideoServiceVisitVideoResult
	if err = p.c.Call(ctx, "VisitVideo", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
