...
import (
	...
	"github.com/ACaiCat/tiktok-go/api/model/interaction"
...
func (s *InteractionService) likeVideoByID(videoIDStr string, userID int64, actionType model.LikeActionType) error {
	...
	case model.LikeActionType_ADD:
		...
		return nil
	case model.LikeActionType_DELETE:
		if !isLiked {
...
func (s *InteractionService) likeCommentByID(commentIDStr string, userID int64, actionType model.LikeActionType) error {
